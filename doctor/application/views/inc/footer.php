 <!-- ======= Footer ======= -->
  <footer id="footer">
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="mr-md-auto text-center text-md-left">
        <div class="copyright">
          &copy; Copyright <strong><span>Dr.Scheduler</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
  ...
  <script src="<?=base_url()?>asset/assets/vendor/bootstrap-datepicker/js/bootstrap-datepicker.min.js"></script>
