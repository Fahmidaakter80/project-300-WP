		...
		<div class="form-group">
		  ...
		  <div class="wrong"><?=form_error('mobile')?></div>
		   ...
		   <div class="form-group">
			...
			<input type="password" name="password" class="form-control" value="<?php if(set_value('password')){ echo set_value('password'); }else{ echo $user[0]['password']; } ?>" placeholder="Enter Password" >
		  </div>
		  <div class="wrong"><?=form_error('password')?></div>
		  
		  <div class="form-group">
			<label for="exampleInputPassword1">Verify Password</label>
			<input type="password" name="verify_password"  class="form-control" value="<?php if(set_value('verify_password')){ echo set_value('verify_password'); }else{ echo $user[0]['password']; } ?>" placeholder="Enter Verify password" >
		  </div>
		 ...
		 <div class="form-group">
			...
			<input type="text" name="deprtment" class="form-control" value="<?php if(set_value('deprtment')){ echo set_value('deprtment'); }else{ echo $user[0]['deprtment']; } ?>" placeholder="Enter Name "  id="exampleInputEmail1" aria-describedby="emailHelp">
		  ...
		  <div class="wrong"><?=form_error('deprtment')?></div>
		   ...
		   <div class="form-group"> 
			...
			<br>
			<img width="200px;" height="200px" src="<?=base_url()?>asset/assets/img/<?=$user[0]['photo']?>" alt="">
			<br>
